...
namespace GalaticBusinessLibrary
{
    public class Aoclite : Planet
    {
        ...
        public Item Helium3 = new Item(0, 150) { BasePrice = 500, BaseQty = 75 };
        public Item WaterIce = new Item(0, 150) { BasePrice = 300, BaseQty = 75 };
        public Item Lead = new Item(0, 20) { BasePrice = 500, BaseQty = 10 };
        public Item Aether = new Item(5, 15) { BasePrice = 750, BaseQty = 9 };
        public Item Food = new Item(0, 150) { BasePrice = 50 };
        public Item DarkMatter = new Item(0, 5) { BasePrice = 10000, BaseQty = 2 };
        public string Description()
        {
            string desc =
                "Aoclite is a large Federation planet, maintained and used to develop weapons for the large\n" +
                "starships the Fereration uses to keep its systems in check... If you can sneak in you might \n" +
                "find some black market sales...";
            return desc;
        }
        public string BuyWelcome()
        {

            string menu = "Welcome to Aoclite please browse our wares. {Press 99 to Exit} ";
            return menu;
        }
        public string OroniOptions()
        {
            string menu = $"Welcome to the Aoclite's Capital City of Oroni\n\n" +
        ...
        public string AocliteSelectionDisplay()
        {

            string bp = $"2 - Otov (10)\n" +
                        $"4 - Larvis (15)\n" +
                        $"6 - Xaenides Station (15)\n\n\n\n" +
