...
{
    public class Gelara : Planet
    {
        public Item Dilithium = new Item() { Weight = 1 };
        public Item Beryllium = new Item(10, 1000) { BaseQty = 700, BasePrice = 150, Weight = 5 };
        public Item Carbon = new Item(50, 250) { BasePrice = 250, Weight = 2 };
        public Item Thorium = new Item(50, 250) { BasePrice = 250, Weight = 10 };
        public Item WaterIce = new Item(0, 150) { BasePrice = 400, BaseQty = 75, Weight = 1 };
        ...
        public Item Food = new Item(0, 150) { BasePrice = 40, Weight = 2 };
        public string Description()
        {
            string desc =
                "Gelara is a small rocky planet that has seen peace since its great war decades ago. It it is known for its\n" +
                "great deal of fresh water, and its unique food...";
            return desc;
        }
        public string BuyWelcome()
        {
            
            string menu = "Welcome to Gelara please browse our wares. {Press 99 to Exit} ";
            return menu;
        }
        public string AbririthOptions()
        {
            string menu = $"Welcome to the Gelara's Capital City of Abririth\n\n" +
        ...
        public string GelaraSelectionDisplay()
        {
