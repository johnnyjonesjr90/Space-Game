...
namespace GalaticBusinessLibrary
{
    public class Larvis : Planet
    {
        ...
        public Item Aether = new Item(5, 25) { BasePrice = 750, BaseQty = 19, Weight = 5 };
        public Item Food = new Item(0, 150) { BasePrice = 50, Weight = 2 };
        public string Description()
        {
            string desc =
                "Larvis is a small planet known for its very large quanitites of carbon, unfortunately it has been taken\n" +
                "over by corporations that work it's inhabitants to death...";
            return desc;
        }
        ...
        public string OntportOptions()
        {
            string menu = $"Welcome to the Larvis' Capital City of Ontport\n\n" +
